...
syllabi <- tribble(
  ...
  "Responsible Data Science", "New York University", "Undergraduate", "Data Science", "Introduction to Data Science<br>(teaches Python)", "Elisha Cohen", "Data Science", 
  '<a target="_top" href = "https://dataresponsibly.github.io/rds23/" target = "_blank">Syllabus Link</a>', "Spring 2023", "Yes"
  )
```
...
DT::datatable(syllabi, escape = FALSE,
              ...
              colnames = c("Course Title", "Institution", "Department", "Course Level",
                           ...
                           "Syllabus Link", "Syllabus' Term", "Reading List Included?"),
              extensions = "Buttons",
